Using C++ create a simple game of dice based upon the following rules:
...
Before programming, start by creating a flowchart to document the logic for the game design.
Upon completion of the flowchart, implement a text-based version of game. Follow good
programming standards for code layout whitespace, naming and commenting.
